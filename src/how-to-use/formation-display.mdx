...
- **Starter Order**: Starter units are numbered in the top right. You can
  reorder starters in the **Starter skill order** panel under the **Items**
  tab.

## Formation Type and Starter Threshold

The tool supports two formation types:

- **Normal**: Starter slots 1-3 are highlighted in yellow, while slots 4-5 are
  highlighted in blue.
- **Final Restriction Release**: Starter slots 1-5 are highlighted in yellow,
  while slots 6-9 are highlighted in blue.

You can set the type manually from the **Formation type** selector above the
preview, or leave it on **Auto**. In auto mode, the tool infers:

- **Normal** when every row has 4 or fewer striker students and 2 or fewer
  special students.
- **Final Restriction Release** if any row exceeds those counts.

You also have the option to move the student up and down in the formation using
the button on the left side of the student configuration area. On the right side
you have the option to remove the student.

You can use the **Empty Striker** and **Empty Special** buttons to add empty
slots (for style points, mostly).

If you have an account on the site, you'll see a tab called **Cloud**, which is
where you can give a name to your formation and save it to your account. You can
access your saved formations in your user corner, either from the home page or
...
- **Vertical Groups**: If enabled, the striker and special unit groups will be
