...
- **Background**:
  - **Background Image**: The background image that will be used in the scenario
    ...
    automatically be resized and centered to fit the screen. You can click on
    the globe icon to use a URL instead of selecting an image from your disk.
  - **Background Scale**: The scale of the background image. This allows you to
    zoom in or out of the background image.
  - **Background X Offset**: The horizontal offset of the background image
    relative to the center of the screen.
  - **Background Y Offset**: The vertical offset of the background image
    relative to the top of the screen.
- **Font**:
  - **Font**: The font family used in the scenario view. Each font is identical
    to the ones used in-game based on region.
...
- **Behavior**:
  - **Text Scroll Speed**: The speed at which the text appears on the screen
    when you start the animation or recording mode. Higher values mean faster
    text.
  - **Transparent Background**: When enabled, the background of the scenario
    screenshot will be transparent.

Additionally, you can add one or more characters to the scene. To do this, click
on one of the **Add Character** buttons in the **Characters** section, depending
on whether you want to select the character's sprite from your computer or a
URL. Once selected, you can configure the following settings for each character:

- **Sprite**: The image of the character, if you'd like to replace it.
...
- **Scale**: The scale of the character's image (1 menas 100% scale). Supports
  decimal values.
- **Darken**: When enabled, the character will have a darker overlay, simulating
  the "not speaking" state in the game.
- **Hologram**: When enabled, the character will have a hologram-like effect,
  simulating the "transmission" effect in the game.
- **Silhouette**: When enabled, the character will be displayed as a silhouette,
  simulating the "mysterious character" effect in the game.
...
To see the text and the triangle animate, you can click on the **Start Animation**
button. Clicking on **Recording Mode** will make the scenario view full screen
and will prompt you to start a screen recording software to capture the browser
window. Once you've done that, you can click on **Start Recording** and the
animation will start playing. You can press the `Esc` key twice to exit
Recording Mode.
